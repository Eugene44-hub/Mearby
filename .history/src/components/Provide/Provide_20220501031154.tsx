...
const Provide = () => {
  const covered:Cover=[
    ...
    {
      img:one,
      text: <>Ratings to promote you and get you more clients plus edu. materials to keep you relevant.
      <span className='text-[#00DCBA]'> We got you</span>  </>  
    },
    {
      img:two,
      text: <>Our system is built to detect traffic and give you the fastest route.
    ...
    {
      img:three,
      text: <>we provide an easy and secure way to enable you to collect a payment, instantly.
     <br />
      <span className='text-[#00DCBA]'> Beat traffic all the time,  Just like magic</span>  </>  
    }
  ]
