...
const Provide = () => {
  const covered:Cover=[
    {
      img:one,
      text: <p>Using precise location tracking, we make it super easy to locate clients <br />
    <span className='text-[#00DCBA]'>Just one click away</span>  </p>  
    },
    {
      img:two,
      text: <p>Our system is built to detect traffic and give you the fastest route.
     <br />
      <span className='text-[#00DCBA]'> Beat traffic all the time, every time</span>  </p>  
    },
    {
      img:three,
      text: <p>We provide a comprehensive analytics  of where your service is most needed
    ...
    {
      img:one,
      text: <p>Ratings to promote you and get you more clients plus edu. materials to keep you relevant.
    ...
    {
      img:three,
      text: <p>we provide an easy and secure way to enable you to collect a payment, instantly.
     <br />
