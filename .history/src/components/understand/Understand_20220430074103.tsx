...
const Understand = () => {
  return (
    <div className='bg-[#004034] mt-[9.75rem]'>
 <div className='container  md:px-0 px-5 pt-[9.75rem] md:py-[5.938rem] md:pl-[61px] md:pr-[27px] md:flex justify-center  relative mt-[20rem]'>
