...
const Understand = () => {
  ...
  return (
    ...
    {/* {  
     ...
     <img src={lines} className='absolute md:translate-x-[10%] lg:translate-x-[40%]  xlg- hidden md:block h-full' alt="lines" />
     <img src={lines} className='absolute md:translate-x-[30%] lg:translate-x-[70%]  xlg- hidden md:block   h-full' alt="lines" />
     <img src={lines} className='absolute md:translate-x-[50%] lg:translate-x-[100%] xlg- hidden md:block  h-full' alt="lines" />
     <img src={lines} className='absolute md:translate-x-[70%] lg:translate-x-[130%] xlg- hidden md:block  h-full' alt="lines" />
