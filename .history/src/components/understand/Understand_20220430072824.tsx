...
const Understand = () => {
  return (
    <div className='container bg-[#004034] md:pl-[61px] md:pr-[27px]'>
 <div className='md:px-0 px-5 pt-[9.75rem] md:flex justify-center  relative mt-[20rem]'>

<img src={understand} className=" absolute block md:hidden translate-x-[-50%] left-[50%] top-[-20%]" alt="understand" />
<div className='md:block hidden '>
<img src={understand} className="mr-5 w-[100%]"alt="understand" />
