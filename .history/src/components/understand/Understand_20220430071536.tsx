...
const Understand = () => {
  ...
  <img src={understand} className=" absolute block md:hiddtranslate-x-[-50%] left-[50%] top-[-20%]" alt="understand" />
  <img src={understand} className=" absolute translate-x-[-50%] left-[50%] top-[-20%]" alt="understand" />
