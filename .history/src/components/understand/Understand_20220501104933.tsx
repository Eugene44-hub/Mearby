...
const Understand = () => {
  return (
    <div className={`bg-[#004034] ${styles.container} relative border-y-4 border-[#00836A] mt-[20rem]`}>
     <img src={lines} className='absolute md:translate-x-[40%]  translate-x-[10%]  h-full' alt="lines" />
     <img src={lines} className='absolute md:translate-x-[70%]  translate-x-[10%]  h-full' alt="lines" />
