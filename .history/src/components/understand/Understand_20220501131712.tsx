...
const Understand = () => {
  ...
  return (
    ...
    {/* {  
     ...
     <img src={lines} className='absolute md:translate-x-[10%] lg:translate-x-[40%]  x- hidden md:block h-full' alt="lines" />
     <img src={lines} className='absolute md:translate-x-[30%] lg:translate-x-[70%]  x- hidden md:block   h-full' alt="lines" />
     <img src={lines} className='absolute md:translate-x-[50%] lg:translate-x-[100%] x- hidden md:block  h-full' alt="lines" />
     <img src={lines} className='absolute md:translate-x-[70%] lg:translate-x-[130%] x- hidden md:block  h-full' alt="lines" />
