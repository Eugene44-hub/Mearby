...
const Understand = () => {
  ...
  return (
    ...
    {/* {  
      darkLine1.map((item,index:number)=>(<img key={index} src={lines} className={`absolute ${`md:translate-x-[${item.md}%]`}  
      lg:translate-x-[${item.lg}%] lg:ml-[10rem]  hidden md:block h-full`}alt="lines" />))} */}
     <img src={lines} className='absolute md:translate-x-[10%] lg:translate-x-[40%]  x-lg:left-[-40%] hidden md:block h-full' alt="lines" />
     <img src={lines} className='absolute md:translate-x-[30%] lg:translate-x-[70%]  xlg:left-[] hidden md:block   h-full' alt="lines" />
     <img src={lines} className='absolute md:translate-x-[50%] lg:translate-x-[100%] xlg:left-[] hidden md:block  h-full' alt="lines" />
     <img src={lines} className='absolute md:translate-x-[70%] lg:translate-x-[130%] xlg:left-[] hidden md:block  h-full' alt="lines" />
