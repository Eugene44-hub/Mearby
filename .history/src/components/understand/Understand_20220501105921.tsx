...
const Understand = () => {
  return (
    <div className={`bg-[#004034] ${styles.container} relative border-y-4 border-[#00836A] mt-[20rem]`}>
     ...
     <img src={mobilelines} className='absolute md:hidden block md:translate-x-[00%]  md:block translate-x-[0%]  h-full' alt="lines" />
     <img src={mobilelines} className='absolute md:hidden block md:translate-x-[70%]  md:block translate-x-[30%]  h-full' alt="lines" />
     <img src={mobilelines} className='absolute md:hidden block md:translate-x-[100%] md:block translate-x-[100%]  h-full' alt="lines" />
     <img src={mobilelines} className='absolute md:hidden block md:translate-x-[130%] md:block translate-x-[130%]  h-full' alt="lines" />
