...
const Understand = () => {
  return (
    <div className={`bg-[#004034] ${styles.container} relative border-y-4 border-[#00836A] mt-[20rem]`}>
     ...
     <img src={lines} className='absolute md:translate-x-[20%] lg:translate-x-[70%]  hidden md:block   h-full' alt="lines" />
     <img src={lines} className='absolute md:translate-x-[40%] lg:translate-x-[100%] hidden md:block  h-full' alt="lines" />
     <img src={lines} className='absolute md:translate-x-[60%] lg:translate-x-[130%] hidden md:block  h-full' alt="lines" />
