...
{[10,30,50,70,90].map((item,index:number)=>(<img key={index} src={lines} className={`absolute left-[${item}%] hidden md:block h-full`}alt="lines" />))}
     <img src={mobilelines} className='absolute md:hidden block left-[10%] h-full' alt="lines" />
     <img src={mobilelines} className='absolute md:hidden block left-[30%]  h-full' alt="lines" />
     <img src={mobilelines} className='absolute md:hidden block left-[50%]  h-full' alt="lines" />
     <img src={mobilelines} className='absolute md:hidden block left-[70%] h-full' alt="lines" />
     <img src={mobilelines} className='absolute md:hidden block left-[90%]  h-full' alt="lines" />
