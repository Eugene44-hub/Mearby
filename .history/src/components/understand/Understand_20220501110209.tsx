...
const Understand = () => {
  return (
    <div className={`bg-[#004034] ${styles.container} relative border-y-4 border-[#00836A] mt-[20rem]`}>
     ...
     <img src={mobilelines} className='absolute md:hidden block translate-x-[130%]  h-full' alt="lines" />
     <img src={mobilelines} className='absolute md:hidden block translate-x-[200%]  h-full' alt="lines" />
     <img src={mobilelines} className='absolute md:hidden block translate-x-[160%]  h-full' alt="lines" />
     <img src={mobilelines} className='absolute md:hidden block translate-x-[170%]  h-full' alt="lines" />
