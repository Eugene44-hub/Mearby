...
const ProfSer = () => {
  ...
  return (
    <div className='p-[20px]'>
      <p className='text-[2rem]'>Nearby is designed to connect you to the best professional service providers <span className="text">wherever</span>  you are and  <span className="text">whenever</span> you need them.</p>
