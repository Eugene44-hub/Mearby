...
<div className='mb-5'>
  ...
  <input placeholder="e.g Meshach Philip" className='bg-[#E3E3E3] py-4 rounded-lg w-full outline-none' type="text" />
</div>
...
<div>
  ...
  <input placeholder="meshachphilip@gmail.com" className='bg-[#E3E3E3] py-4 rounded-lg w-full outline-none' type="text" />
</div>
        </form>
    </section>
