...
<div className='container md:pl-[61px] md:pr-[57px]'>
        ...
        <form action="#">
<div className='mb-5'>
  <label className='capitalize font-bold mb-4' htmlFor="fullname">fullname</label> <br />
  <input className='bg-[#E3E3E3] py-4 rounded-lg w-full outline-none' type="text" />
</div>
<div>
  <label className='capitalize font-bold mb-4' htmlFor="email">email</label> <br />
  <input className='bg-[#E3E3E3] py-4 rounded-lg w-full outline-none' type="text" />
</div>
        </form>
    </section>
